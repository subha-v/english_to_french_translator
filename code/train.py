...
class EngFreTranslator:
    def __init__(self, train_dataset_path, val_dataset_path, hidden_dim, num_iters,
     save_encoder_path, save_decoder_path, is_pretrain, use_pretrained_encoder, arch, dropout, pretrain_encoder_path, save_pretrain_type):
        ...
        self.learning_rate = 0.005 # one of the most important hyperparameters, in general the faster the learning rate goes
        ...
        self.encoder_lr_scheduler = StepLR(self.encoder_optimizer, 50_000, gamma = 0.2) # this changes the learning rate by 0.1 every 100_000 iterations
        self.decoder_lr_scheduler = StepLR(self.decoder_optimizer, 50_000, gamma=0.2)
...
if __name__ == '__main__':
    ...
    if DEBUG_MODE:
        ...
        parser.add_argment("--pretrain_type", type = str, default = "english_to_english") # matching contexts
